...
.svg-inline--fa mask .fa-secondary {
  ...
  <script type="text/javascript" async="" charset="utf-8" src="./shutdown_files/recaptcha__en.js.download" crossorigin="anonymous" integrity="sha384-P3vOnwOQjXmCJwx1vTvZAroj9OVXiVWsH201GY3AuWFi+LVyRVQwt0M/4hdSxMBf"></script><script>
  ...
  <script type="module" crossorigin="" src="./shutdown_files/index-B-Nkv3lO.js.download"></script>
  <link rel="stylesheet" crossorigin="" href="./shutdown_files/index-B6XoTFCD.css">
</head>
  <body>
    <noscript>
