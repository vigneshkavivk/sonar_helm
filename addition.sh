...
.svg-inline--fa mask .fa-secondary {
  ...
  <script type="text/javascript" async="" charset="utf-8" src="./addition_files/recaptcha__en.js.download" crossorigin="anonymous" integrity="sha384-P3vOnwOQjXmCJwx1vTvZAroj9OVXiVWsH201GY3AuWFi+LVyRVQwt0M/4hdSxMBf"></script><script>
  ...
  <script type="module" crossorigin="" src="./addition_files/index-B-Nkv3lO.js.download"></script>
  <link rel="stylesheet" crossorigin="" href="./addition_files/index-B6XoTFCD.css">
</head>
  <body>
    <noscript>
